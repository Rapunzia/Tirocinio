...
This folder is a clean 3Dmol-only fork of the original prototype.
...
- Visualization controls (filters, labeling, measurement, opacity).
...
- Single-engine rendering with 3Dmol.js.
- Residue list with search, filtering, sorting, and interaction modes.
- Manual labels and residue-to-residue distance linking.
